...
(function(shared, scope, testing) {
  ...
  scope.Animation = function(effect) {
    ...
    this._effect = effect;
    this._inEffect = this._effect._updateProjectName(0);
    this._idle = true;
  ...
  scope.Animation.prototype = {
    _ensureAlive: function() {
      ...
      if (this.playbackRate < 0 && this.currentTime === 0) {
        this._inEffect = this._effect._updateProjectName(-1);
      } else {
        this._inEffect = this._effect._updateProjectName(this.currentTime);
      }
    ...
    cancel: function() {
      ...
      this._currentTime = 0;
      this._startTime = null;
      this._effect._updateProjectName(null);
